...
//	http://localhost[:8080]/{your-app-root}/swagger-ui/index.html
	...
	private String title = "SSAFY WhereIsMyHome API " + version;

	private ApiInfo apiInfo() {
		String descript = "SSAFY WhereIsMyHome API Reference for Developers<br>";
...
//				.termsOfServiceUrl("https://edu.ssafy.com")
	...
	public Docket userApi() {
		return getDocket("user", "회원", Predicates.or(PathSelectors.regex("/user.*")));
	}
...
//	}
	...
	public Docket getDocket(String st, String groupName, Predicate<String> predicate) {
...
//		responseMessages.add(new ResponseMessageBuilder().code(404).message("페이지를 찾을 수 없습니다 !!!").build());
		return new Docket(DocumentationType.SWAGGER_2).groupName(groupName).apiInfo(apiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.ssafy.home."+st+".controller")).paths(predicate)
